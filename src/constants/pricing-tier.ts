...
export const PricingTier: Tier[] = [
  {
    ...
    featured: false,
    priceId: { month: 'pri_01jvkxendcqgfmb1bsab1cb8r2', year: 'pri_01jvkxfkt5q66ea66tck84e8mc' },
  },
  {
    name: 'Pro',
    id: 'pro',
    ...
    featured: true,
    priceId: { month: 'pri_01jvkxsnhpkytxc658gb5hsbqq', year: 'pri_01jvkxtbxzk3m5z9fwwv51m1hp' },
  },
  // {
  //   name: 'Advanced',
  //   id: 'advanced',
